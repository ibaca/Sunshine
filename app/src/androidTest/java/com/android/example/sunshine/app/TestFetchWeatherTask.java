...
public class TestFetchWeatherTask extends AndroidTestCase {
    ...
    public void testAddLocation() {
        ...
        getContext().getContentResolver().delete(LocationEntry.CONTENT_URI,
                LocationEntry.COLUMN_LOCATION_SETTING + " = ?",
                new String[]{ADD_LOCATION_SETTING});

        long locationId = MainActivityFragmentKt.addLocation(getContext(),
        ...
        for (int i = 0; i < 2; i++) {
            ...
            long newLocationId = MainActivityFragmentKt.addLocation(getContext(),
                    ADD_LOCATION_SETTING, ADD_LOCATION_CITY, ADD_LOCATION_LAT, ADD_LOCATION_LON);
